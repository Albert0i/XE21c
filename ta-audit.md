...
Total 18 tables: 
```
TACARTITEMS       TACARTITEMS_LOG   TACARTS
TACHGRET          TACHGRSN          TACONTRACTS
TACREASONS        TACRESULTS        TACTYPES
TADAYS            TAFAMILY          TANOTES
TAOPTIONS         TASKS             TASTATUS
TATIMES           TAUNSIGN          TAUSERS
```
...
ALTER TABLE DCDEVDTA.TACHGRET          ADD (createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt TIMESTAMP);
ALTER TABLE DCDEVDTA.TACHGRSN          ADD (createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, updatedAt TIMESTAMP);
...
CREATE OR REPLACE TRIGGER DCDEVDTA.TRG_TACHGRET_AUDIT
BEFORE INSERT OR UPDATE ON DCDEVDTA.TACHGRET
FOR EACH ROW
BEGIN
  IF INSERTING THEN
    :NEW.createdAt := COALESCE(:NEW.createdAt, CURRENT_TIMESTAMP);
...
CREATE OR REPLACE TRIGGER DCDEVDTA.TRG_TACHGRSN_AUDIT
BEFORE INSERT OR UPDATE ON DCDEVDTA.TACHGRSN
FOR EACH ROW
BEGIN
  IF INSERTING THEN
    :NEW.createdAt := COALESCE(:NEW.createdAt, CURRENT_TIMESTAMP);
...
DROP TRIGGER DCDEVDTA.TRG_TACHGRET_AUDIT;
DROP TRIGGER DCDEVDTA.TRG_TACHGRSN_AUDIT;
...
ALTER TABLE DCDEVDTA.TACHGRET          DROP COLUMN createdAt;
ALTER TABLE DCDEVDTA.TACHGRET          DROP COLUMN updatedAt;
ALTER TABLE DCDEVDTA.TACHGRSN          DROP COLUMN createdAt;
ALTER TABLE DCDEVDTA.TACHGRSN          DROP COLUMN updatedAt;
