...
#### IX. Summary
Oracle 21c is a little bit stale, to be honest, my department is still using 19c! The good news is *All discussion so far also works for 23ai and 26ai*. 
...
If you want to test drive XE 21c and do not have Docker environment, XE 21c installer is available on Windows 11 and Linux platform. As of 23ai, installer is only available on Linux.  
